...
| 3-4 行為對映審查 | 完成 | SC-043~050（8張）× 46 個 scenario 標記逐條比對，通過、無不對齊；SC-043 起始基準 1.0、SC-044 四級邊界、SC-045 兩文案分流（跨 SC-049 呈現層覆蓋）、SC-047 端到端持久化不受影響、SC-050 t05 修訂後 L0/L1 內容皆確認真被鎖定；1 項觀察（SC-049 累積TWR/淨值指標渲染未測，屬既有 views 慣例非本次缺口）；pytest 63 綠 |
| 3-Z 最終驗證 | 完成 | scenario-lint 50/50 全覆蓋、marker 有效；pytest 282 綠；AppTest 啟動無例外、fail-closed 守門全過、總覽 default 落地頁確認；Phase 3 審查改動未破壞 runtime，可進 Phase 4 |
